...
def evaluate_codes(model, dataset, loss_fn, output_size, historical=None):
    ...
    for step in range(len(dataset)):
        code_x, procedure_x, medication_x, visit_lens, divided, y, neighbors, visit_intervals = dataset[step]
        output = model(code_x, divided, neighbors, visit_lens, visit_intervals)
    ...
    return avg_loss, f1_score, recall[0], recall[1], recall[2], recall[3]
